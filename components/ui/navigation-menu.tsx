...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 items-center justify-center rounded-full px-4 py-2 text-sm font-medium transition-colors duration-200 outline-none hover:text-[var(--color-ink)] focus-visible:ring-2 focus-visible:ring-[var(--color-electric)]/30 focus-visible:ring-offset-2 data-[state=open]:bg-white data-[state=open]:text-[var(--color-ink)]",
);
